...
<head>
    ...
    <link rel="stylesheet" href="/test/public/components/driver/touristDrivers/touristDriver.css">
...
<body>
            ...
            <section class="cards-grid">
                <article class="profile-card">
                    <div class="profile-avatar">
                        <img src="/test/public/components/driver/images/driver-saman-perera-84.png" alt="Saman Perera">
                    </div>
                ...
                <article class="profile-card">
                    <div class="profile-avatar">
                        <img src="/test/public/components/driver/images/driver-jane-smith-123.png" alt="Ruwan Silva">
                    </div>
                ...
                <article class="profile-card">
                    <div class="profile-avatar">
                        <img src="/test/public/components/driver/images/driver-john-doe-112.png" alt="Nimal Fernando">
                    </div>
                ...
                <article class="profile-card">
                    <div class="profile-avatar">
                        <img src="/test/public/components/driver/images/driver-saman-perera-84.png" alt="Chaminda Rathnayake">
                    </div>
                ...
                <article class="profile-card">
                    <div class="profile-avatar">
                        <img src="/test/public/components/driver/images/driver-jane-smith-123.png" alt="Kasun Mendis">
                    </div>
                ...
                <article class="profile-card">
                    <div class="profile-avatar">
                        <img src="/test/public/components/driver/images/driver-john-doe-112.png" alt="Lakshan Perera">
                    </div>
    ...
    <script src="/test/public/components/driver/touristDrivers/touristDriver.js"></script>
</body>
</html>
