<!-- Hero Section -->
    ...
    <section class="services-section">
        <h2 class="section-title">Our Services For Travelers</h2>
    ...
    <section class="business-section">
        <h2 class="section-title">Grow Your Travel Business with Us</h2>
    ...
    <!-- Discover Our Exclusive Travel Packages -->
    ...
    <section class="community-section">
        <h2 class="section-title">Join with our growing community</h2>
    ...
    <section class="journey-section">
        ...
        <p class="journey-text">Whether you're a Traveler crafting your dream adventure in Sri Lanka, or Local Driver / Guide looking to grow your travel business.</p>
        <p class="journey-subtext">This is the perfect platform for you.</p>
    </section>
