(function () {
	...
	const root = document.getElementById('guidesExploreTop');
	if (!root) {
		return;
	}

	const searchInput = root.querySelector('#guideSearch');
	const searchButton = root.querySelector('#guideSearchButton');
	const resultsInfo = root.querySelector('#searchResultsInfo');
	const noResults = root.querySelector('#guideNoResults');
