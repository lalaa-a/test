(function() {
    ...
    loadSubtabContent('subtabHelpdesk'); // Load default tab content on page load
    ...
    async function loadSubtabContent(subtabId){
        ...
        try{     
            ...
            const {ok,loadingContent} = await fetch('http://localhost/test/RegUser/support/'+`${subtabId}`).then(r=>r.json());
