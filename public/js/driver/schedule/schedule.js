(function() {
    ...
    const defaultTab = 'subtabTours'; // Set your default tab ID here
    loadSubtabContent(defaultTab); // this will load the default tab content on page load
    ...
    async function loadSubtabContent(subtabId){
        ...
        try{     
            ...
            const {ok,loadingContent} = await fetch(URL_ROOT+'/Driver/'+`${subtabId}`).then(r=>r.json());
