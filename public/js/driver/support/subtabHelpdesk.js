(function () {
	...
	function mapContactToTarget(contact, targetType) {
		...
		return {
			...
			targetUserId: id,
			name,
			subtitle: 'Traveller connected to your requests',
	...
	function isOutgoingMessage(message) {
		...
		return String(message.sender_type || '') === String(state.viewerSenderType || 'Driver');
	}
	...
	async function loadTargets() {
		...
		try {
			const result = await requestJson(`${URL_ROOT}/helpc/getDriverSupportContacts`);
