(function () {
	...
	async function loadProblems() {
		...
		try {
			const response = await fetch(`${URL_ROOT}/Guide/getUserProblemsByUserId?filter=${encodeURIComponent(currentFilter)}`);
	...
	async function submitProblem(event) {
		...
		try {
			const response = await fetch(`${URL_ROOT}/Guide/submitProblem`, {
				method: 'POST',
				headers: {
