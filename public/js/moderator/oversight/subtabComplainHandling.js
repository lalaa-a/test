...
// Complain Handling JavaScript
    ...
    class ComplainHandlingManager {
        ...
        async loadComplaints() {
            try {
                const response = await fetch(`${this.URL_ROOT}/Moderator/getAllComplaints`);
        ...
        async showComplaintDetails(complaintId) {
            try {
                const response = await fetch(`${this.URL_ROOT}/Moderator/getComplaintDetails?complaintId=${complaintId}`);
                const data = await response.json();
        ...
        async startHandling(complaintId = null) {
            ...
            try {
                const response = await fetch(`${this.URL_ROOT}/Moderator/startComplaintHandling`, {
                    method: 'POST',
                    headers: {
        ...
        async markCompleted(complaintId = null) {
            ...
            try {
                const response = await fetch(`${this.URL_ROOT}/Moderator/markComplaintCompleted`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
