...
<head>
    ...
    <title>Explore Entertainment & Activities Destinations</title>
    <!-- Fonts -->
...
<body>
    ...
    <main class="main-content">
        ...
        <section class="search-section">
            ...
            <p class="search-subtitle">Find your Entertainment & Activities Destinations</p>
    ...
    <!-- Page Title -->
    <h1 class="page-title">Entertainment & Activities Destinations</h1>
        ...
        <div class="content-container">
            ...
            <aside class="sidebar">
                ...
                <!-- Entertainment Type (place-based) -->
                <div class="filter-section">
                    <h3 class="filter-title">Entertainment Type</h3>
                ...
                <div class="filter-section">
                    <h3 class="filter-title">Suitability</h3>
                    <div class="filter-option">
                        <div class="checkbox-container">
                    ...
                    <div class="filter-option">
                        <div class="checkbox-container">
                            ...
                            <label for="kids">Kids / Child-friendly</label>
                        </div>
                    </div>
                </div>
                ...
                <!-- Booking / Ticketing -->
                <div class="filter-section">
                    <h3 class="filter-title">Booking / Ticketing</h3>
                    <div class="filter-option">
                        <div class="checkbox-container">
                    ...
                    <div class="filter-option">
                        <div class="checkbox-container">
                            <input type="checkbox" id="paid-ticket">
                            <label for="paid-ticket">Paid / Ticketed</label>
                        </div>
                    </div>
                    <div class="filter-option">
                        <div class="checkbox-container">
                ...
                <!-- Region / Venue Name -->
                <div class="filter-section">
                    <h3 class="filter-title">Region / Venue</h3>
                    <input type="text" class="filter-input" placeholder="e.g. Colombo, National Stadium">
                </div>
            ...
            <div class="destinations-grid">
                ...
                <div class="destination-card">
                    ...
                    <div class="destination-info">
                        ...
                        <span class="destination-category">Entertainment & Activities</span>
                ...
                <div class="destination-card">
                    <div class="destination-image">
                        <img src="<?php echo IMG_ROOT; ?>/explore/destinations/mirissa.png" alt="Mirissa">
                    </div>
                    <div class="destination-info">
                ...
                <div class="destination-card">
                    <div class="destination-image">
                        <img src="<?php echo IMG_ROOT; ?>/explore/destinations/galle.png" alt="Galle">
                    </div>
                    <div class="destination-info">
    ...
    <script>
        ...
        function navigateToDestination(url) {
