...
<head>
    ...
    <title>Explore Nature & Adventure Destinations</title>
    <!-- Fonts -->
...
<body>
    ...
    <!-- Page Title -->
    <h1 class="page-title">Nature & Adventure Destinations</h1>
        ...
        <div class="content-container">
            ...
            <aside class="sidebar">
                ...
                <div class="filter-section">
                    <h3 class="filter-title">Activity Type</h3>
                    ...
                    <div class="filter-option">
                        <div class="checkbox-container">
                            ...
                            <label for="wildlife">Wildlife / Safari</label>
                        </div>
                    </div>
                    <div class="filter-option">
                        <div class="checkbox-container">
                            <input type="checkbox" id="water-sports">
                    ...
                    <div class="filter-option">
                        <div class="checkbox-container">
                            <input type="checkbox" id="birding">
                            <label for="birding">Bird Watching</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="filter-section">
                    ...
                    <div class="filter-option">
                        <div class="checkbox-container">
                            ...
                            <label for="hard">Hard / Challenging</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="filter-section">
                    ...
                    <div class="filter-option">
                        <div class="checkbox-container">
                            ...
                            <label for="short">Short (&lt; 2 hours)</label>
                        </div>
                    </div>
                    <div class="filter-option">
                        <div class="checkbox-container">
                    ...
                    <div class="filter-option">
                        <div class="checkbox-container">
                            ...
                            <label for="multi-day">Multi-Day / Overnight</label>
                        </div>
                    </div>
                </div>

                <!-- Trail Length / Elevation Filter -->
                <div class="filter-section">
                    <h3 class="filter-title">Trail Length / Elevation</h3>
                    <input type="text" class="filter-input" placeholder="e.g. 3 km, 800 m ascent">
                </div>

                <!-- Permits / Fees Filter -->
                <div class="filter-section">
                    <h3 class="filter-title">Permits / Fees</h3>
                    <div class="filter-option">
                        <div class="checkbox-container">
                    ...
                    <div class="filter-option">
                        <div class="checkbox-container">
                            ...
                            <label for="paid">Paid / Permit Required</label>
                        </div>
                    </div>
                </div>
                ...
                <!-- Best Season Filter -->
                <div class="filter-section">
                    <h3 class="filter-title">Best Season</h3>
                    <div class="filter-option">
                        <div class="checkbox-container">
                            <input type="checkbox" id="dry-season">
                            <label for="dry-season">Dry Season</label>
                        </div>
                    </div>
                    <div class="filter-option">
                        <div class="checkbox-container">
                            <input type="checkbox" id="wet-season">
                            <label for="wet-season">Wet / Monsoon Season</label>
                        </div>
                    </div>
                </div>

                <!-- Guided Tours / Family Friendly Filter -->
                <div class="filter-section">
                    <h3 class="filter-title">Options</h3>
                    <div class="filter-option">
                        <div class="checkbox-container">
                            <input type="checkbox" id="guided">
                            <label for="guided">Guided Tours Available</label>
                        </div>
                    </div>
                    <div class="filter-option">
                        <div class="checkbox-container">
                ...
                <div class="filter-section">
                    ...
                    <input type="text" class="filter-input" placeholder="e.g. Central Province">
                </div>
            ...
            <div class="destinations-grid">
                ...
                <div class="destination-card">
                    ...
                    <div class="destination-info">
                        ...
                        <span class="destination-category">Nature & Adventure</span>
                ...
                <div class="destination-card">
                    <div class="destination-image">
                        <img src="<?php echo IMG_ROOT; ?>/explore/destinations/mihinthale.png" alt="Mihinthale">
                    </div>
                    <div class="destination-info">
