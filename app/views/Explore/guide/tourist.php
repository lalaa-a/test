...
<body>
    ...
    <main class="main-content">
        ...
        <section class="search-section">
            ...
            <p class="search-subtitle">Find your guide from our trusted network</p>
        ...
        <h1 class="page-title">Tourist Guides</h1>
            ...
            <section class="cards-grid">
                ...
                <?php else: ?>
                    ...
                    <article class="profile-card">
                        ...
                        <p class="profile-desc">Specialist tourist guide with extensive experience in cultural heritage tours and visitor hospitality.</p>
                        <button class="select-driver-btn">Select Guide</button>
                    </article>
                    ...
                    <article class="profile-card">
                        ...
                        <p class="profile-desc">Expert tourist guide specializing in adventure tourism and outdoor activities for international visitors.</p>
                        <button class="select-driver-btn">Select Guide</button>
                    </article>
                    ...
                    <article class="profile-card">
                        ...
                        <p class="profile-desc">Premier tourist guide with multilingual skills and deep knowledge of Sri Lankan attractions and culture.</p>
                        <button class="select-driver-btn">Select Guide</button>
                    </article>
