        ...
        <div class="profile-header">
            ...
            <div class="profile-info">
                ...
                <p class="driver-role">Professional Driver</p>
        ...
        <div class="profile-content">
                ...
                <div class="section-content">
                    ...
                    <form id="personalForm" class="profile-form" style="display: none;">
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea id="bio" name="bio" rows="4" placeholder="Tell us about your driving experience, specialties, and what makes you a great driver..."></textarea>
                        </div>
            ...
            <!-- License Sections Row -->
            <div class="profile-sections-row">
                <!-- Driver License Section -->
                <div class="profile-section">
                    <div class="section-header">
                        <h2><i class="fas fa-id-card"></i> Driver License</h2>
                ...
                <div class="section-content">
                    <!-- Read-only view -->
                    <div id="driverLicenseView" class="license-verified">
                        <div class="verified-license">
                            ...
                            <div class="verified-photos">
                                <div class="verified-photo-item">
                                    <label class="photo-label">Front of License</label>
                                    <div class="verified-photo">
                                        <img id="verifiedDriverLicenseFront" src="" alt="Verified License Front" style="display: none;">
                                        <div class="license-placeholder">
                                            <i class="fas fa-id-card"></i>
                                            <p>License verified by system</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="verified-photo-item">
                                    <label class="photo-label">Back of License</label>
                                    <div class="verified-photo">
                                        <img id="verifiedDriverLicenseBack" src="" alt="Verified License Back" style="display: none;">
                                        <div class="license-placeholder">
                                            <i class="fas fa-id-card"></i>
                                            <p>License verified by system</p>
                                        </div>
                            ...
                            <div class="verified-details-row">
                                <div class="verified-info">
                                    <p><strong>License Number:</strong> <span id="verifiedDriverLicenseNumber">-</span></p>
                                    <p><strong>Valid Until:</strong> <span id="verifiedDriverLicenseExpiry">-</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Under Review view -->
                    <div id="driverLicenseReview" class="license-pending" style="display: none;">
                        <div class="pending-license">
                            ...
                            <div class="pending-details">
                                <p>Your driver license has been submitted and is currently under review by our moderators. The verification process typically takes 2-3 minutes.</p>
                                <div class="pending-info">
                                    <p><strong>Submitted:</strong> <span id="driverLicenseSubmittedDate">-</span></p>
                    ...
                    <!-- Edit view -->
                    <div id="driverLicenseEdit" class="license-info" style="display: none;">
                        <div class="license-photos">
                            <div class="license-photo-item">
                                <label class="photo-label">Front of License</label>
                                <div class="photo-placeholder" id="licenseFrontContainer">
                                    <i class="fas fa-id-card"></i>
                                    <p>No front photo uploaded</p>
                                </div>
                                <button class="btn-upload-photo" id="uploadLicenseFrontBtn">
                                    <i class="fas fa-camera"></i> Upload Front
                                </button>
                                <input type="file" id="licenseFrontInput" accept="image/*" style="display: none;">
                            </div>
                            <div class="license-photo-item">
                                <label class="photo-label">Back of License</label>
                                <div class="photo-placeholder" id="licenseBackContainer">
                                    <i class="fas fa-id-card"></i>
                                    <p>No back photo uploaded</p>
                                </div>
                                <button class="btn-upload-photo" id="uploadLicenseBackBtn">
                                    <i class="fas fa-camera"></i> Upload Back
                                </button>
                                <input type="file" id="licenseBackInput" accept="image/*" style="display: none;">
                            </div>
                        </div>
                        <div class="license-details">
                            <form id="licenseForm" class="profile-form">
                                <div class="form-row">
                                    <div class="form-group">
                    ...
                    <div class="section-actions">
                        <button class="btn-edit" id="editDriverLicenseBtn">
                            <i class="fas fa-edit"></i> Edit
                        </button>
                        <button class="btn-cancel" id="cancelDriverLicenseBtn" style="display: none;">
                            <i class="fas fa-times"></i> Cancel
                        </button>
                        <button class="btn-save" id="updateDriverLicenseBtn" style="display: none;">
                ...
                <!-- Tourist Driver License Section -->
                <div class="profile-section">
                    <div class="section-header">
                        <h2><i class="fas fa-certificate"></i> Tourist Driver License</h2>
                        <div class="header-actions">
                ...
                <div class="section-content">
                    ...
                    <div id="touristLicenseReview" class="license-pending" style="display: none;">
                        <div class="pending-license">
                            ...
                            <div class="pending-details">
                                <p>Your tourist driver license has been submitted and is currently under review by our moderators. The verification process typically takes 2-3 minutes.</p>
                                <div class="pending-info">
