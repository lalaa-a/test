...
<div class="page-header">
    <div class="page-header-content">
        <div class="page-title-section">
            <h1 class="page-title">Trip Requests</h1>
    ...
    <div class="modal-content large-modal">
        ...
        <div class="modal-body">
            <div class="request-details-tabs">
                <button class="tab-btn active" onclick="driverRequestsManager.switchModalTab('details')">Details</button>
                <button class="tab-btn" onclick="driverRequestsManager.switchModalTab('itinerary')">Itinerary</button>
            </div>
