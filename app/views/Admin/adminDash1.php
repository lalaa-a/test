...
<head>
    ...
    <link href="<?php echo URL_ROOT; ?>/app/views/Trips/usertrip.css" rel="stylesheet">
...
<body>
    ...
    <script src="<?php echo URL_ROOT; ?>/app/views/Trips/usertrip.js"></script>
    ...
    // <<-----------Tab management ------------------->
        ...
        async function loadTabContent(tabId) {
            ...
            try {
                // AJAX request to fetch tab content
                const response = await fetch('<?= URL_ROOT ?>/RegUser/'+`${tabId}`);
                ...
                // Clean up previous tab assets
                cleanupPreviousAssets(tabId);

                const data = await response.text();
                
                // Inject HTML
                tabElement.innerHTML =  data;
