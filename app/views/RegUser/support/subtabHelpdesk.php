...
>
	<div class="subtab-header">
		...
		<p>Message site support or contact your selected guides and drivers from one place.</p>
	</div>
	...
	<div class="helpdesk-layout">
		<aside class="support-target-panel">
			...
			<div class="target-filter-tabs" role="tablist" aria-label="Filter support contacts">
				...
				<button type="button" class="target-filter-tab" data-filter="drivers">Drivers</button>
				<button type="button" class="target-filter-tab" data-filter="guides">Guides</button>
			</div>
		...
		<div class="helpdesk-chat-shell">
			...
			<div class="helpdesk-chat-messages" id="helpdeskChatMessages" aria-live="polite">
				<div class="empty-chat-state">
					...
					<p>Choose Site Support, a driver, or a guide to begin chatting.</p>
				</div>
			</div>
