...
<body>
    ...
    $adminNotificationItems = get_notifications_for_user($adminUser['id'] ?? null, 20);
    $adminUnreadCount = count_unread_notifications($adminNotificationItems);
    ?>
    <!-- Sidebar -->
    <div class="sidebar">
    ...
    <div class="main-content">
        ...
        <div class="header">
            ...
            <div class="header-actions">
                <button type="button" class="header-action-btn" id="notificationsBtn" title="Notifications">
                    ...
                    <span class="notification-badge" id="notificationBadge" style="display: <?php echo $adminUnreadCount > 0 ? 'flex' : 'none'; ?>;"><?php echo (int)$adminUnreadCount; ?></span>
                </button>
                <button type="button" class="header-action-btn" id="messagesBtn" title="Messages" onclick="window.location.href='<?php echo URL_ROOT . '/admin/oversight' ?>';">
        ...
        <script>
            ...
            // Messages button
            const messagesBtn = document.geFtElementById('messagesBtn');
            ...
            if (messagesBtn) {
                messagesBtn.addEventListener('click', function(e) {
                    e.preventDefault();
                    window.location.href = '<?php echo URL_ROOT . '/admin/oversight' ?>';
                });
            }
            ...
            window.driverDashboardNotifications = <?php echo json_encode($adminNotificationItems, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES); ?>;
