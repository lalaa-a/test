<?php
    ...
    $guideNotificationItems = get_notifications_for_user($loggedInUser['id'] ?? null, 20);
    $guideUnreadCount = count_unread_notifications($guideNotificationItems);
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="header">
            ...
            <div class="header-actions">
                <button type="button" class="header-action-btn" id="notificationsBtn" title="Notifications">
                    ...
                    <span class="notification-badge" id="notificationBadge" style="display: <?php echo $guideUnreadCount > 0 ? 'flex' : 'none'; ?>;"><?php echo (int)$guideUnreadCount; ?></span>
                </button>
                <button type="button" class="header-action-btn" id="messagesBtn" title="Messages" onclick="window.location.href='<?php echo URL_ROOT.'/Guide/support'?>';">
    ...
    <script>
        ...
        if (messagesBtn) {
            messagesBtn.addEventListener('click', function(e) {
                e.preventDefault();
                window.location.href = '<?php echo URL_ROOT.'/Guide/support'?>';
            });
        }
        ...
        window.driverDashboardNotifications = <?php echo json_encode($guideNotificationItems, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES); ?>;
