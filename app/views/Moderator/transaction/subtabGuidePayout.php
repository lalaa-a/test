<!-- Guide Payouts Content -->

<!-- Page Header -->
<div class="page-header">
    <div class="page-header-content">
        <div class="page-title-section">
            <h1 class="page-title">Guide Payouts</h1>
            <p class="page-subtitle">Manage completed, pending, and cancelled guide payouts</p>
        </div>
    </div>
</div>
                    ...
                    <div class="search-filter-section">
                        ...
                        <div class="filter-dropdown">
                            <select id="completedPayoutFilter" class="filter-select">
                                ...
                                <option value="guide">Guide Payouts</option>
                            </select>
                        </div>
                    </div>
                </div>
...
<div id="payoutDetailsModal" class="modal">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <button class="modal-close" onclick="guidePayoutsManager.closeModal('payoutDetailsModal')">
        ...
        <div class="modal-footer">
            <button class="btn btn-secondary" onclick="guidePayoutsManager.closeModal('payoutDetailsModal')">Close</button>
        </div>
    </div>
</div>
