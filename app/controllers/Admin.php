...
class Admin extends Controller
{
    ...
    public function content()
    {
        ...
        ob_start();
        $this->view('Admin/content/content');
        $html =  ob_get_clean();

        $loadingContent = [
            'html' => $html,
            'css'  => URL_ROOT . '/public/css/admin/content/content.css',
            'js'   => URL_ROOT . '/public/js/admin/content/content.js'
        ];
    ...
    public function subtabFilters()
    {
        ...
        ob_start();
        $this->view('Admin/content/contentFilters');
        $html = ob_get_clean();

        $loadingContent = [
            'html' => $html,
            'css'  => URL_ROOT . '/public/css/admin/content/subtabFilters.css',
            'js'   => URL_ROOT . '/public/js/admin/content/subtabFilters.js'
        ];
    ...
    public function subtabTravelSpots()
    {
        ...
        ob_start();
        $this->view('Admin/content/contentTravelSpots');
        $html = ob_get_clean();

        $loadingContent = [
            'html' => $html,
            'css'  => URL_ROOT . '/public/css/admin/content/subtabTravelSpots.css',
            'js'   => URL_ROOT . '/public/js/admin/content/subtabTravelSpots.js'
        ];
