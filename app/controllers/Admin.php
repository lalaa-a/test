...
class Admin extends Controller
{
    ...
    {
        ob_start();
        $this->view('Admin/oversight/subtabComplainHandling');
        $html = ob_get_clean();

        $loadingContent = [
            'html' => $html,
            'css'  => URL_ROOT . '/public/css/admin/oversight/subtabComplainHandling.css',
            'js'   => URL_ROOT . '/public/js/admin/oversight/subtabComplainHandling.js'
        ];
    ...
    public function getAllComplaints()
    {
        ...
        try {
            $complaints = $this->adminModel->getAllComplaintsGrouped();
    ...
    public function getComplaintDetails()
    {
        ...
        try {
            $complaint = $this->adminModel->getComplaintDetails($complaintId);
    ...
    public function startComplaintHandling()
    {
        ...
        try {
            $result = $this->adminModel->startComplaintHandling($complaintId, $adminId);
    ...
    public function markComplaintCompleted()
    {
        ...
        try {
            $result = $this->adminModel->markComplaintCompleted($complaintId, $adminId);
